...
do
  cat <<EOF >2019A-0005-sdss-standard-$suffix-low-airmass
proposal::setidentifier "2019A-0005";
...
EOF
  cat <<EOF >2019A-0005-sdss-standard-$suffix-medium-airmass
proposal::setidentifier "2019A-0005";
block::setidentifier $targetid
...
EOF
  cat <<EOF >2019A-0005-sdss-standard-$suffix-high-airmass
proposal::setidentifier "2019A-0005";
block::setidentifier $targetid
