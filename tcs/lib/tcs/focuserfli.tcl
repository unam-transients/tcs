...
# $Id: focuserfli.tcl 3557 2020-05-22 18:23:30Z Alan $
...
package provide "focuserfli" 0.0

load [file join [directories::prefix] "lib" "focuserfli.so"] "focuser"
...
namespace eval "focuser" {
  ...
  proc openspecific {identifier} {
    ...
    return [focuserrawopen $identifier]
  }
