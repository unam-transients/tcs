...
namespace eval "html" {
  ######################################################################
  variable servers [concat { "html" } [config::getvalue "html" "servers"] ]
  ...
  proc writehtmlstatusblock {server} {
    ...
    writehtmltimestampedrowwithemph "Status" $statustimestamp "$emph" $status
    writehtmltimestampedrow "Process" $starttimestamp $pid
    ...
    if {[string equal $status "ok"]} {
      ...
      if {[string equal $activity "error"]} {
        writehtmltimestampedrowwithemph "Requested activity" $requestedactivitytimestamp "warning" $requestedactivity
        writehtmltimestampedrowwithemph "Current activity" $activitytimestamp "error" $activity
      } elseif {![string equal $activity $requestedactivity]} {
        writehtmltimestampedrowwithemph "Requested activity" $requestedactivitytimestamp "warning" $requestedactivity
        writehtmltimestampedrowwithemph "Current activity" $activitytimestamp "warning" $activity
      } else {
        writehtmltimestampedrowwithemph "Requested activity" $requestedactivitytimestamp "" $requestedactivity
        writehtmltimestampedrowwithemph "Current activity" $activitytimestamp "" $activity
      }
      writehtmltimestampedrow "Current data" $timestamp
    } else {
  ...
  proc writeccd {server} {
    ...
    if {[string equal [client::getstatus $server] "ok"]} {
      ...
      if {![string equal "" [client::getdata $server "detectorframetime"]]} {
        writehtmlrow "Detector frame time" \
          [format "%.1f ms" [expr {1e3 * [client::getdata $server "detectorframetime"]}]]
      }
      if {![string equal "" [client::getdata $server "detectorcycletime"]]} {
        writehtmlrow "Detector cycle time" \
          [format "%.1f ms" [expr {1e3 * [client::getdata $server "detectorcycletime"]}]]
      }
      ...
      writehtmlrow "Cooler set temperature" \
        [formatifok "%+.1f C" [client::getdata $server "detectorcoolersettemperature"]]
      ...
      if {![string equal "" [client::getdata $server "detectorcoldendtemperature"]]} {
        writehtmlrow "Cold end temperature" \
          [formatifok "%+.1f C" [client::getdata $server "detectorcoldendtemperature"]]
      }
      if {![string equal "" [client::getdata $server "detectorpowersupplytemperature"]]} {
        writehtmlrow "Power supply temperature" \
          [formatifok "%+.1f C" [client::getdata $server "detectorpowersupplytemperature"]]
      }
      ...
      if {![string equal "" [client::getdata $server "detectorcompressorsupplypressure"]]} {
        writehtmlrow "Compressor supply pressure" \
          [formatifok "%.0f psi" [client::getdata $server "detectorcompressorsupplypressure"]]
      }
      if {![string equal "" [client::getdata $server "detectorcompressorreturnpressure"]]} {
        writehtmlrow "Compressor return pressure" \
          [formatifok "%.0f psi" [client::getdata $server "detectorcompressorreturnpressure"]]
      }
      ...
      if {![string equal "" [client::getdata $server "detectordetectorheatercurrent"]]} {
        writehtmlrow "Detector heater current" \
          [formatifok "%.2f A" [client::getdata $server "detectordetectorheatercurrent"]]
      }
      if {![string equal "" [client::getdata $server "detectorcoldendheatercurrent"]]} {
        writehtmlrow "Cold end heater current" \
          [formatifok "%.2f A" [client::getdata $server "detectorcoldendheatercurrent"]]
      }
      ...
      writehtmlrow "Solved position (α,δ)" [formatalphaifdouble [client::getdata $server "solvedalpha"]] \
      ...
      writehtmltimestampedrow "Last correction" [client::getdata $server "lastcorrectiontimestamp"]
      writehtmlrow "Last correction (E,N)" [formatoffsetifdouble [client::getdata $server "lastcorrectioneastoffset"]] \
        [formatoffsetifdouble [client::getdata $server "lastcorrectionnorthoffset"]]
      writehtmlrow "FWHM" [formatarcsecifdouble "%.2fas" [client::getdata $server "fwhm"]]
      writehtmlrow "Average and Standard Deviation" [formatifok "%.1f" [client::getdata $server "average"]] \
  ...
  proc writedome {} {
    ...
    if {[string equal [client::getstatus "dome"] "ok"]} {
      ...
      writehtmlrow "Maximum absolute azimuth error" \
        [formatradtodegifdouble "%+.1f°" [client::getdata "dome" "maxabsazimutherror"]]
    }
  ...
  proc writetarget {} {
    ...
    if {[string equal [client::getstatus "target"] "ok"]} {
      writehtmlrow "Requested position (α,HA,δ)" [formatalphaifdouble [client::getdata "target" "requestedalpha"]] \
        [formathaifdouble    [client::getdata "target" "requestedha"]] \
        [formatdeltaifdouble [client::getdata "target" "requesteddelta"]]
      writehtmlrow "Requested equinox" [formatifok "%.2f" [client::getdata "target" "requestedequinox"]]
      writehtmlrow "Requested offset (α,δ)" [formatoffsetifdouble [client::getdata "target" "requestedalphaoffset"]] \
        "" [formatoffsetifdouble [client::getdata "target" "requesteddeltaoffset"]]
      writehtmltimestampedrow "Requested epoch" [client::getdata "target" "requestedepochtimestamp"]
      writehtmlrow "Requested rate (α,δ)" [formatrateifdouble [client::getdata "target" "requestedalpharate"]] "" \
        [formatrateifdouble [client::getdata "target" "requesteddeltarate"]]
      writehtmlrow "Requested aperture" [client::getdata "target" "requestedaperture"]
      writehtmlrow "Current position (α,HA,δ)" [formatalphaifdouble [client::getdata "target" "currentalpha"]] \
        [formathaifdouble    [client::getdata "target" "currentha"]] \
        [formatdeltaifdouble [client::getdata "target" "currentdelta"]]
      writehtmlrow "Current equinox" [formatifok "%.2f" [client::getdata "target" "currentequinox"]]
      writehtmlrow "Standard position (α,HA,δ)" [formatalphaifdouble [client::getdata "target" "standardalpha"]] "" \
      ...
      writehtmlrow "Observed rate (α,δ)" [formatrateifdouble [client::getdata "target" "observedalpharate"]] \
      ...
      writehtmlrow "Observed rate (A,z)" [formatrateifdouble [client::getdata "target" "observedazimuthrate"]] \
      ...
      writehtmlrow "Within limits" [client::getdata "target" "withinlimits"]
    }
  ...
  proc writemoon {} {
    ...
    if {[string equal [client::getstatus "moon"] "ok"]} {
      writehtmlrow "Observed position (α,HA,δ)" [formatalphaifdouble [client::getdata "moon" "observedalpha"]] \
      ...
      writehtmlrow "Illuminated" [format "%2.0f%%" [expr {[client::getdata "moon" "illuminatedfraction"] * 100}]]
    }
  ...
  proc writetelescopecontroller {} {
    ...
    if {[string equal [client::getstatus "telescopecontroller"] "ok"]} {
      ...
      writehtmlrow "Ambient temperature" \
        [formatifok "%.1f C"    [client::getdata "telescopecontroller" "ambienttemperature"]]
      writehtmlrow "Ambient pressure" \
        [formatifok "%.1f mbar" [client::getdata "telescopecontroller" "ambientpressure"   ]]
    }
    ...
    if {[string equal [client::getstatus "plc"] "ok"]} {
      switch $type {
        colibri {
          ...
          writehtmlrow "Vaisala wind gust speed" [formatifok "%.0f km/h" [client::getdata "plc" "vaisalawindmaxspeed"]]
          writehtmlrow "Boltwood wind speed" [formatifok "%.0f km/h" [client::getdata "plc" "boltwoodwindspeed"]]
          writehtmlrow "Wind speed limit" [formatifok "%.0f km/h" [client::getdata "plc" "windspeedlimit"]]

          writehtmlrow "PLC cabinet temperature" [format "%+.1f C" [client::getdata "plc" "plccabinettemperature"]]
          writehtmlrow "Weather cabinet temperature" \
            [format "%+.1f C" [client::getdata "plc" "weathercabinettemperature"]]
          writehtmlrow "Seeing cabinet temperature" \
            [format "%+.1f C" [client::getdata "plc" "seeingcabinettemperature"]]

          writehtmlrow "American UPS battery charge level" \
            [format "%.0f%%" [expr {[client::getdata "plc" "americanupsbatterychargelevel"] * 100}]]
          writehtmlrow "European UPS battery charge level" \
            [format "%.0f%%" [expr {[client::getdata "plc" "europeanupsbatterychargelevel"] * 100}]]
        }
      }
    }
  ...
  proc writesun {} {
    ...
    if {[string equal [client::getstatus "sun"] "ok"]} {
      writehtmlrow "Observed position (α,HA,δ)" [formatalphaifdouble [client::getdata "sun" "observedalpha"]] \
  ...
  proc writemount {} {
    ...
    if {[string equal [client::getstatus "mount"] "ok"]} {
      writehtmlrow "LAST" \
        [formatalphaifdouble [astrometry::last [utcclock::scan [client::getdata "mount" "timestamp"]]]]
      ...
      writehtmlrow "Requested standard equinox" [formatifok "%.2f" [client::getdata "mount" "requestedstandardequinox"]]
      ...
      if {![string equal "" [client::getdata "mount" "port"]]} {
        writehtmlrow "Current port" [client::getdata "mount" "port"] [client::getdata "mount" "portindex"]
      }
      writehtmlrow "Current mount rotation" [formatradtodegifdouble "%.2f°"  [client::getdata "mount" "mountrotation"]]
      writehtmlrow "Current mount position (α,HA,δ)" [formatalphaifdouble [client::getdata "mount" "mountalpha"]] \
      ...
      writehtmlrow "Unparked" [client::getdata "mount" "unparked"]
  ...
  proc writeweather {} {
    ...
    if {[string equal [client::getstatus "weather"] "ok"]} {
      ...
      writehtmlrow "Temperature" [format "%+.1f C" [client::getdata "weather" "temperature"]] \
        [client::getdata "weather" "temperaturetrend"]
      writehtmlrow "Dewpoint" [format "%+.1f C" [client::getdata "weather" "dewpoint"]] \
        [client::getdata "weather" "dewpointtrend"]
      writehtmlrow "Dewpoint depression" [format "%+.1f C" [client::getdata "weather" "dewpointdepression"]] \
        [client::getdata "weather" "dewpointdepressiontrend"]
      writehtmlrow "Humidity" [formatpercentifok "%.0f%%" [client::getdata "weather" "humidity"]] \
        [client::getdata "weather" "humiditytrend"]
      if {![string equal [client::getdata "weather" "windaveragespeed"] "unknown"]} {
        writehtmlrow "Wind average speed" [format "%.0f km/h" [client::getdata "weather" "windaveragespeed"]] \
      ...
      if {![string equal [client::getdata "weather" "windgustspeed"] "unknown"]} {
        writehtmlrow "Wind gust speed" [format "%.0f km/h" [client::getdata "weather" "windgustspeed"]] \
      ...
      writehtmlrow "No alarms for" [format "%.1f m" [expr {[client::getdata "weather" "noalarmseconds"] / 60.0}]]
      if {![string equal [client::getdata "weather" "rainrate"] "unknown"]} {
        writehtmlrow "Rain rate" [format "%.1f mm/h" [client::getdata "weather" "rainrate"]]
      } else {
        writehtmlrow "Rain rate"
      }
      if {![string equal [client::getdata "weather" "skytemperature"] "unknown"]} {
        writehtmlrow "Sky temperature" [format "%+.1f C" [client::getdata "weather" "skytemperature"]] \
      ...
      if {![string equal [client::getdata "weather" "pressure"] "unknown"]} {
        writehtmlrow "Pressure" [format "%.1f mbar" [client::getdata "weather" "pressure"]] \
      ...
      writehtmlrow "Humidity limit" [formatpercentifok "%.0f%%" [client::getdata "weather" "humiditylimit"]]
  ...
  proc writeseeing {} {
    ...
    if {[string equal [client::getstatus "seeing"] "ok"]} {
      ...
      writehtmlfullrowwithemph "Seeing" $emphasis \
        "[utcclock::format $timestamp] [formatarcsecifdouble "%.2fas" $seeing]"
  ...
  proc writeexecutor {} {
    ...
    if {[string equal [client::getstatus "executor"] "ok"]} {
      ...
      writehtmlrow "Alert coordinates" [formatalphaifdouble [client::getdata "executor" "alertalpha"]] \
  ...
  proc writegcntan {} {
    ...
    if {[string equal [client::getstatus "gcntan"] "ok"]} {
      writehtmlrow "Swift pointing (α,δ)" [formatalphaifdouble [client::getdata "gcntan" "swiftalpha"]] \
  ...
  proc writeinfo {} {
    ...
    set civiliseconds \
      [clock scan [clock format $iseconds -timezone $civiltimezone -format "%Y-%m-%d %H:%M:%S"] -format \
      "%Y-%m-%d %H:%M:%S"]
  ...
  proc start {} {
    ...
    after idle { coroutine ::server::writehtmlloopcoroutine html::writehtmlloop }
  }
  ######################################################################
}
