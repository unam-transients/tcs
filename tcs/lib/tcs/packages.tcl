...
# $Id: packages.tcl 3613 2020-06-20 20:21:43Z Alan $
...
package ifneeded executorcolibricito   0.0 \
...
package ifneeded opentsiserver         0.0 \
  [list source [file join [file dirname [info script]] opentsiserver.tcl]]
...
package ifneeded temperaturesserver    0.0 \
  [list source [file join [file dirname [info script]] temperaturesserver.tcl]]
