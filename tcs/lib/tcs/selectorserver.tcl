...
namespace eval "selectorserver" {
  ...
  proc slaverespondtoalert {blockidentifier name origin identifier type alerttimestamp eventtimestamp enabled alpha delta equinox uncertainty class messenger fixedpriority preliminary} {
  ...
  proc slavemodifyalert {identifier name alpha delta equinox uncertainty maxalertdelay minha maxha priority filters} {
    selector::modifyalert $identifier $name $alpha $delta $equinox $uncertainty $maxalertdelay $minha $maxha $priority $filters
  }
  ...
  proc configureslave {slave} {
    ...
    interp alias $slave reselect          {} selectorserver::slavereselect
