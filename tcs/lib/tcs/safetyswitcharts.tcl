...
# $Id: safetyswitcharts.tcl 3594 2020-06-10 14:55:51Z Alan $
...
package provide "safetyswitcharts" 0.0
...
namespace eval "safetyswitch" {
  ...
  proc checksafetyswitch {} {
    ...
    set safetyswitch ""
    if {
      [catch {client::update "enclosure"}] ||
      [catch {set safetyswitch [client::getdata "enclosure" "mode"]}] ||
