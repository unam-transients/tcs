...
EOF
  ...
  gnuplot <<EOF
    ...
    plot \
      ...
      "sensors.dat"  using 24:25 title "Rack"        with lines linestyle 3
    
    plot \
      "weather.dat"  using 1:2   title "External"       with lines linestyle 1, \
      "sensors.dat"  using 4:5   title "Enclosure"      with lines linestyle 2, \
      "sensors.dat"  using 6:7   title "Platform Box"   with lines linestyle 3, \
      "sensors.dat"  using 8:9   title "Instrument Box" with lines linestyle 4
    ...
    plot \
      ...
      "sensors.dat"  using 1:(\$11*100) title "Shed"        with lines linestyle 2
    
    plot \
      "weather.dat"  using 1:(\$4*100)   title "External"       with lines linestyle 1, \
      "sensors.dat"  using 12:(\$13*100) title "Enclosure"      with lines linestyle 2, \
      "sensors.dat"  using 14:(\$15*100) title "Platform Box"   with lines linestyle 3, \
      "sensors.dat"  using 16:(\$17*100) title "Instrument Box" with lines linestyle 4

    set yrange [-10:5000]
    set ytics 0,500,5000
    set format y "%.0f"
    ...
    plot \
      "sensors.dat"  using 18:(\$19*5000) title "Shed (arbitrary units)"  with lines linestyle 1, \
      "sensors.dat"  using 20:21          title "Enclosure" with lines linestyle 2
    ...
    plot \
      ...
      "C0.dat"       using 1:6  title "C0 Set"      with lines linestyle 2, \
