...
rm -f 0010-landolt-standard-field-*
...
do
  cat <<EOF >0010-landolt-standard-field-$suffix-low-airmass
...
EOF
  cat <<EOF >0010-landolt-standard-field-$suffix-medium-airmass
proposal::setidentifier "[utcclock::semester]-0010";
block::setidentifier $targetid
...
EOF
  cat <<EOF >0010-landolt-standard-field-$suffix-high-airmass
proposal::setidentifier "[utcclock::semester]-0010";
block::setidentifier $targetid
